	...
	<center>
		<section class="row">
                <article >
                    ...
                    <?php
                        $ci_p=$_REQUEST['ci_p'];
                        $id_tu_met=$_REQUEST['id_jurado_2'];

                        include("conexion.php");
                        $conn=conectar();

                        $query="SELECT  pr.ci_p, pr.nom_p, pr.es_p, pr.activo,pr.estatus_jurado_2,
                                        ju2.es_jurado_2,ju2.id_jurado_2,
                                        es.escuela, es.descripcion
                               FROM     jurado_2 AS ju2
                                INNER JOIN profesor AS pr
                                ON ju2.ci_jur_2=pr.ci_p
                                INNER JOIN escuela AS es 
                                ON ju2.es_jurado_2=es.escuela
                                WHERE activo=1
                    ...
                    <table align="center" border="2px" class="caja2">
                        <form action="eliminar2.php" method="POST">
                            <tr>
                                ...
                                <td><input type="text" REQUIRED name="id_jurado_2" placeholder=" solo numeros..." value="<?php echo $row['id_jurado_2'];?>"><br></td>
                            </tr>
                            <tr>
