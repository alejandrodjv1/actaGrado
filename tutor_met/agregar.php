...
<body>
	...
	<center>
		<section class="row">
                <article >
                    <h1>Agregar Profesor a<br>Lista de Tutor Metodologico.???</h1>
                    <?php
                    ...
                    <table align="center" border="2px" class="caja2">
                        <form action="operacion_agregar.php" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" REQUIRED name="es_p" placeholder=" "
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" REQUIRED name="descripcion" placeholder=" "
                                    value="<?php echo utf8_encode($row['descripcion']);?>"/>
                                </td>
                            </tr>
