		...
		<table  align="center" border="3" class="caja2">
			<thead>
				<tr>
					...
					<td colspan="3"><a href="eliminar.php?id_tesis_te=<?php echo $id_tesis_te;?>&ci_a=<?php echo $ci_a;?>" class="bla">Regresar </a></td>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				?>
							...
							<td><?php echo $ao=$f1[0]-2000;?></td>
								...
								<td colspan="3"><a href="agregar_fecha.php?id_fecha=<?php echo $row['id_fecha'];?>&id_tesis_te=<?php echo $id_tesis_te;?>">Agregar</a></td>
	                                </tr>
				<?php
