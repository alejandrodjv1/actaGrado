...
$ced_tutor_met =$_GET['ced_tutor_met'];
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <table  align="center" border="3" class="caja2">
            <thead>
                <tr>
                    ...
                    <td colspan="3"><a href="eliminar.php?id_tesis_te=<?php echo $id_tesis_te;?>&ci_a=<?php echo $ced_tesis;?>">Regresar</a></td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td colspan="4"  bgcolor="orange">OPERACIONES  </td>
                        <?php $res=$conn->query($query);
                            while($row=$res->fetch_assoc()){?>
                                    ...
                                    <td rowspan="1"><a href="agregar_mod_met_tesis.php?id_tesis_te=<?php echo $id_tesis_te;?>&id_tu_met=<?php echo $row['id_tu_met'];?>&ced_tesis=<?php echo $ced_tesis;?>">Agregar</a></td>
                                </tr>
