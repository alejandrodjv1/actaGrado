                    ...
                    <table align="center" border="2px" class="caja2">
                        <form action="operacion_agregar.php" method="POST">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="ci_a" placeholder=" solo numeros..." 
                                    value="<?php echo $row['ci_a'];?>"><br></td>
                            </tr>
                            <tr>
                                <td><label>Nombres<br>Apellidos:</label></td>
                                <td><input type="text" name="nom_a" placeholder=" solo letras..." 
                                    value="<?php echo $row['nom_a'];?>"/><br></td>
                            </tr>
