        ...
        <table  align="center" border="3" class="caja2">
            <thead>
                <tr>
                    ...
                    <th colspan="8"><h1>Listado de Profesores<br>para elegir Asesor Academico</h1></th>
                    <td colspan="3"><a href="eliminar.php?id_tesis_te=<?php echo $id_tesis_te;?>&ced_tesis=<?php echo $ced_tesis;?>">Regresar</a></td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td colspan="4"  bgcolor="orange">OPERACIONES  </td>
                        <?php $res=$conn->query($query);
                            while($row=$res->fetch_assoc()){?>
                                    ...
                                    <td rowspan="1"><a href="agregar_mod_acad_tesis.php?id_tesis_te=<?php echo $id_tesis_te;?>&id_tu_acad=<?php echo $row['id_tu_acad'];?>&ced_tesis=<?php echo $ced_tesis;?>">Agregar</a></td>
                                </tr>
