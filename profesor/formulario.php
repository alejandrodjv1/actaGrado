                    ...
                    <table  align="center" border="3" class="caja2">
                        <form action="operacion_guardar.php" method="POST">
                            <tr>
                                ...
                                <td><input type="text" REQUIRED name="ci_p" placeholder=" solo numeros..." 
                                    value="" minlength="7" maxlength="10" required pattern="[0-9,.]+" autofocus
                                    title="solo números. Tamaño mínimo: 7. Tamaño máximo: 10"><br></td>
                            </tr>
                            <tr>
                                <td><label>Nombres<br>Apellidos:</label></td>
                                <td><input type="text" REQUIRED name="nom_p" placeholder=" solo letras..." value=""
                                    minlength="5" maxlength="40" required pattern="[A-Za-z,ñ,"" ]*"
                                     title="solo Letras. mínimo: 5 letras. máximo: 40 letras"/><br></td>
                            </tr>
                            
                            <tr>
                                <tr><td><label>Escuela :</label></td>
                                    <td><input type="text" REQUIRED name="es_p" placeholder=" Codigo escuela... "
                            ...
                            <tr>
                                ...
                                <input type="radio" name="activo" valeu="0"><br>
                            </tr>
