                    ...
                    <table align="center" border="2px" >
                        <form action="operacion_guardar.php" method="POST">
                            <tr>
                                ...
                                <td><input type="text" REQUIRED name="ci_a" placeholder="solo numeros..." value=""><br></td>
                            </tr>
                            <tr>
                                <td><label>Nombre:</label></td>
                                <td><input type="text" REQUIRED name="nombre" placeholder="solo letras..." value=""/><br><br></td>
                            </tr>
                            
                            <tr>
                                <tr>
                                <td><label>Escuela :</label></td>
                                <td><input type="text" REQUIRED name="escuela" placeholder="solo numeros..." value=""/><br/></td>
                            </tr>
                            <tr>
                                <td><label>Materia Pendiente:</label></td>
                                <td><input type="text" REQUIRED name="mat_Pend" placeholder="solo numeros..." value=""/><br/></td>
                            </tr>
                            <tr>
                                <td><label>Nota Proyecto:</label></td>
                                <td><input type="text" REQUIRED name="nota_Proy" placeholder="solo numeros..." value=""/><br/></td>
                            </tr>
