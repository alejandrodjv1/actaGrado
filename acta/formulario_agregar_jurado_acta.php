            ...
            <tbody>
                ...
                <?php
                    ...
                    $query="SELECT  ju1.id_jurado_1,ju1.ci_jur_1,ju1.nom_ju_1,ju1.es_jurado_1,ju1.id_tesis_jurado_1,
                                    ...
                                    es.escuela,pr4.estatus_jurado_1
                ...
                ?> 
                        <tr>
                            ...
                            <?php   if($row['activo']==1){?>
                                        <td colspan="2"><?php echo $row['ci_jur_1' ];?></td>
                                        <td colspan="2"><?php echo $row['nom_p' ];?></td><?php
                                    }elseif($row['activo']==0){?>
                                        <td colspan="2" bgcolor="#F4FA58">  <?php echo $row['ci_jur_1' ];?></td>
                                        <td colspan="2" bgcolor="#F4FA58">  <?php echo $row['nom_p' ];?></td><?php
                                    }?> 
                            
                            <td colspan="3" ><a href="eliminar1.php?ci_p=<?php echo $row['ci_p'];?>&id_jurado_1=<?php echo $row['id_jurado_1'];?>">Eliminar</a></td>
                        </tr>
                <?php
                    }
                ?>
