		...
		<table  align="center" border="3" class="caja2">
			<thead>
				<tr>
					...
					<td colspan="4"><h1>Lista de Fecha</h1></td>
					<td colspan="6"><center>
										<form action="operacion_buscar.php" method="POST">
											<table>
												<tr>Codigo fecha:<br><input type="text" REQUIRED name=" id_fecha" placeholder=" solo numeros..." value=""/>
			...
			<tbody>
				...
				?>
							...
							<td><?php echo $ao=$f1[0]-2000;?></td>
								...
								<td colspan="3"><a href="agregar_fecha.php?id_fecha=<?php echo $row['id_fecha'];?>">Agregar</a></td>
	                                </tr>
				<?php
