                    ...
                    <table  align="center" border="3px" class="caja2">
                        <form action="operacion_modificar.php" method="POST">
                            ...
                            <tr>
                                ...
                                <tr>
                                <td><label>FECHA<br> PREDEFENSA:<br><a href="formulario_fecha.php?id_fecha=<?php echo $row['id_fecha'];?>&id_tesis_te=<?php echo $id_tesis;?>&ced_tesis=<?php echo $ced_tesis;?>">Buscar</a></td>
                                <td><input type="text" name="fecha_pre" placeholder="" 
                                    value="<?php echo $fecha_pre;?>"/><br>
                                    <input type="text" name="hora_pre" placeholder="" 
                                    value="<?php echo $hora_pre;?>"/><br>
                                    <input type="text" name="aula_pre" placeholder="" 
                                    value="<?php echo $aula_pre;?>"/></td>
                            </tr>
                            <tr>
                                <td><label>FECHA <br> DEFENSA:<br><a href="formulario_fecha.php?id_fecha=<?php echo $row['id_fecha'];?>&id_tesis_te=<?php echo $id_tesis;?>&ced_tesis=<?php echo $ced_tesis;?>">Buscar</a></td>
                                <td><input type="text" name="fecha_def" placeholder="" 
                                    value="<?php echo $fecha_def;?>"/><br>
                                    <input type="text" name="hora_def" placeholder="" 
                                    value="<?php echo $hora_def;?>"/><br>
                                    <input type="text" name="aula_def" placeholder="" 
                                    value="<?php echo $aula_def;?>"/></td>
                            </tr>
