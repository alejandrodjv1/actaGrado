...
<body>
	...
	<center>
		<section class="row">
                <article >
                    <h1>Seguro de Agregar<br> Primer Jurado de la Tesis..???</h1>
                    <?php
                        ...
                        $query="SELECT *
                                ...
                                WHERE pr.activo=1
                                AND ju1.id_jurado_1=$id_jurado_1
                    ...
                    <table align="center" border="2px" class="caja2">
                        <form action="operacion_agregar_jurado_1.php" method="POST">
                            ...
                            <tr>
                                <td><label bgcolor="orange">Id<br>jurado:</label></td>
                            ...
                            <input type="hidden" name="id_tesis_te" placeholder=" " value="<?php echo $id_tesis_te;?>"/>
                            <input type="hidden" name="id_jurado_1" placeholder=" " value="<?php echo $id_jurado_1;?>"/>

                            <td ><input type="submit" name="Aceptar" value="Aceptar"></td>
                            <td><a href="formulario_3.php?id_acta=<?php echo $id_acta;?>&id_tesis_te=<?php echo $id_tesis_te;?>&id_jurado_1=<?php echo $row['id_jurado_1'];?>&ced_tutor_acad=<?php echo $ced_tutor_acad;?>&ced_tesis=<?php echo $ced_tesis;?>&escuela=<?php echo $escuela;?>">Regresar</a></td></tr>
