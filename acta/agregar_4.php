...
<body>
	...
	<center>
		<section class="row">
                <article >
                   <h1>Seguro de Agregar<br> Segundo Jurado de la Tesis..???</h1>
                    <?php
                    ...
                    <table align="center" border="2px" class="caja2">
                        <form action="operacion_agregar_jurado_2.php" method="POST">
                           ...
                           <tr>
                            ...
                            <td><a href="formulario_4.php?id_acta=<?php echo $id_acta;?>&id_tesis_te=<?php echo $id_tesis_te;?>&id_jurado_2=<?php echo $row['id_jurado_2'];?>&ced_tutor_acad=<?php echo $ced_tutor_acad;?>&ced_tesis=<?php echo $ced_tesis;?>&escuela=<?php echo $escuela;?>">Regresar</a></td>
