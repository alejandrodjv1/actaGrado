               ...
               <tr>
                ...
                ?> 
                         <tr>
                                    ...
                                    <td rowspan="1"><a href="agregar_4.php?id_acta=<?php echo $id_acta;?>&id_tesis_te=<?php echo $id_tesis_te;?>&id_jurado_2=<?php echo $row['id_jurado_2'];?>&ced_tutor_acad=<?php echo $ced_tutor_acad;?>&ced_tesis=<?php echo $ced_tesis;?>&escuela=<?php echo $escuela;?>">Agregar</a></td>
                                </tr>
                <?php
                    }
                ?>
