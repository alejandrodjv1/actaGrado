<?php
	...
	if($res){
		...
		if($res1){
			$query="	UPDATE alumno
				SET estatus_acta='$estatus_acta'
				WHERE ci_a='$ced_tesis'";
			
				//echo $query.$query1.$estatus_tutor_met;
				header("Location: formulario_fecha.php?id_acta=$id_acta&id_tesis_te=$id_tesis_te&escuela=$escuela&ced_tesis=$ced_tesis&ced_tutor_acad=$ced_tutor_acad");
