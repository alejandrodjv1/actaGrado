            ...
            <tbody>
                ...
                ?> 
                       <tr>
                                    ...
                                    <td colspan="3"><a href="agregar_5_mod.php?id_acta=<?php echo $id_acta;?>&id_jurado_1=<?php echo $id_jurado_1;?>&ced_tutor_acad=<?php echo $ced_tutor_acad;?>">Agregar</a></td>
                                </tr>
                <?php
                    }
                ?>
