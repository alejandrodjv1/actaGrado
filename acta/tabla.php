   ...
   <nav class="navegacion">
	...
	<center>
		...
		<table  align="center" border="3" class="caja2">
			<thead>
				<tr>
					<td colspan="3"><a href="formulario_tesis.php"> Agregar Acta </a>
										...
										<form action="tabla_buscar.php" method="POST">
											<table>
												<tr>Cedula tesista:<br><input type="hidden" name="id_tesis_te" 
													placeholder="" value="" autofocus autocomplete=""/>
			...
			<tbody>
				<tr>
					...
					<td  bgcolor="orange" colspan="1">P R I M E R JURADO:  </td>
					<td  bgcolor="orange" colspan="1">S E G U N D O JURADO:  </td>
					<td  bgcolor="orange" colspan="1">T E R C E R JURADO:  </td>
					<td  bgcolor="orange" colspan="1">NOTA DEFINITIVA:  </td>
					<td  bgcolor="orange" colspan="1">MENCION TESIS:  </td>
				...
				$query="SELECT *
                        ...
                        INNER JOIN mencion AS men
						ON ac.id_menc=men.id_menc
						INNER JOIN escuela AS es
						ON al.es_a=es.escuela
						INNER JOIN fecha AS fe
						ON ac.id_fecha_a=fe.id_fecha
				...
				while($row=$res->fetch_assoc()){?>
					...
					<tr>
						...
						<td colspan="1"><?php echo utf8_decode($row['descripcion'])?></td>
						...
						<td colspan="1"><?php echo "V- ".$row['ci_jur_1' ]?><br><?php echo $row['nom_ju_1' ];?><br><a href="formulario_3_mod.php?id_acta=<?php echo $row['id_acta'];?>&id_jurado_1=<?php echo $row['id_jurado_1'];?>&ced_tutor_acad=<?php echo $row['ced_tutor_acad'];?>";>"Cambiar</a> </td>
						<td colspan="1"><?php echo "V- ".$row['ci_jur_2' ]?><br><?php echo $row['nom_ju_2' ];?><br><a href="formulario_4_mod.php?id_acta=<?php echo $row['id_acta'];?>&id_jurado_1=<?php echo $row['id_jurado_1'];?>&ced_tutor_acad=<?php echo $row['ced_tutor_acad'];?>";>Cambiar</a> </td>
						<td colspan="1"><?php echo "V- ".$row['ci_jur_3' ]?><br><?php echo $row['nom_ju_3' ];?><br><a href="formulario_5_mod.php?id_acta=<?php echo $row['id_acta'];?>&id_jurado_1=<?php echo $row['id_jurado_1'];?>&ced_tutor_acad=<?php echo $row['ced_tutor_acad'];?>";>Cambiar</a> </td>
						
                        <td colspan="1"><?php echo $row['nota_ac' ]?><br>										   			<a href="formulario_nota.php?id_acta=<?php echo $row['id_acta'];?>&nota_ac=<?php echo $row['nota_ac'];?>&id_menc=<?php echo $row['id_menc'];?>&ced_tesis=<?php echo $row['ced_tesis'];?>&id_tesis_te=<?php echo $row['id_tesis_te'];?>">Cambiar</a> </td>
						
                        <td colspan="1"><?php echo $row['id_menc']?><br><?php echo ($row['mencion']);?><br> 		<a href="formulario_nota.php?id_acta=<?php echo $row['id_acta'];?>&nota_ac=<?php echo $row['nota_ac'];?>&id_menc=<?php echo $row['id_menc'];?>&ced_tesis=<?php echo $row['ced_tesis'];?>&id_tesis_te=<?php echo $row['id_tesis_te'];?>">Cambiar</a> </td>
						...
						<td colspan="1"><a href="pdf/acta_pdf_1.php?id_acta=<?php echo $row['id_acta'];?>&ced_tesis=<?php echo $row['ced_tesis'];?>">Imprimir Acta</a><br><br>
										<a href="eliminar.php?id_acta=<?php echo $row['id_acta'];?>&ci_a=<?php echo $row['ci_a'];?>&id_tesis_te=<?php echo $row['id_tesis_te'];?>&estatus_fecha_tesis=<?php echo $row['estatus_fecha_tesis'];?>&id_fecha=<?php echo $row['id_fecha'];?>">Eliminar</a>
										</td>
	                </tr>
					<tr>
