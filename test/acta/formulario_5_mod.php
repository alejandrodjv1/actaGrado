            ...
            <tbody>
                ...
                <?php
                    ...
                    $query="SELECT  ju3.id_jurado_3,ju3.ci_jur_3,ju3.nom_ju_3,ju3.es_jurado_3,ju3.id_tesis_jurado_3,
                                    ...
                                    es.escuela,es.descripcion,pr4.estatus_jurado_3
                ...
                ?> 
                       <tr>
                                    ...
                                    <td rowspan="1"><a href="agregar_5_mod.php?id_acta=<?php echo $id_acta;?>&id_tesis_te=<?php echo $id_tesis_te;?>&id_jurado_3=<?php echo $row['id_jurado_3'];?>&ced_tutor_acad=<?php echo $ced_tutor_acad;?>&ced_tesis=<?php echo $ced_tesis;?>&escuela=<?php echo $escuela;?>">Agregar</a></td>
                                </tr>
                <?php
                    }
                ?>
