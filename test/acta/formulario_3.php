            ...
            <tbody>
                ...
                <?php
                   ...
                   // $res=$conn->query($query);$row=$res->fetch_assoc();$ced_tutor_acad=$row['ced_tutor_acad'];
                    ...
                    $query="SELECT  ju1.id_jurado_1,ju1.ci_jur_1,ju1.nom_ju_1,ju1.es_jurado_1,ju1.id_tesis_jurado_1,
                                    pr4.ci_p,pr4.es_p,pr4.nom_p,pr4.activo,
                                    pr4.estatus_tu_met_pr,pr4.estatus_tu_acad_pr,
                                    es.escuela,es.descripcion,pr4.estatus_jurado_1
                ...
                ?> 
                        <tr>
                             <tr>
                                    ...
                                    <td rowspan="1"><a href="agregar_3.php?id_acta=<?php echo $id_acta;?>&id_tesis_te=<?php echo $id_tesis_te;?>&id_jurado_1=<?php echo $row['id_jurado_1'];?>&ced_tutor_acad=<?php echo $ced_tutor_acad;?>&ced_tesis=<?php echo $ced_tesis;?>&escuela=<?php echo $escuela;?>">Agregar</a></td>
                                </tr>
