...
$estatus_tutor_acad =$_GET['estatus_tutor_acad'];
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <center>
        ...
        <table  align="center" border="3" class="caja2">
            <thead>
                <tr>
                    <th colspan="2"></th>
                    <th colspan="9"><h1>Elegir un profesor para<br>Primer Jurado</h1></th>
                    <td colspan="3"><a href="tabla.php">Regresar</a></td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td colspan="1"  bgcolor="orange">ID<br>tesis</td>
                ...
                <?php
                            ...
                            $query="SELECT  
                                ...
                                pr.id_p,pr.activo,pr.ci_p,pr.es_p,pr.estatus_tu_met_pr,pr.nom_p,
                                   ...
                                   AND pr.estatus_jurado_1=1
                                    ...
                                    AND te.id_jurado_1=0
                                    AND te.id_jurado_2=0
                                    AND te.id_jurado_3=0
                                    AND te.id_tesis_te=$id_tesis_te                                                                     
                                    ORDER BY te.id_tesis_tes ASC
                                    ";
                        ...
                        ?>
                                ...
                                <tr>
                                    <td><input type="text" name="estatus_tutor_acad" placeholder=" " 
                                                value="<?php echo $estatus_tutor_acad;?>"/></td>
                                    <td><input type="text" name="id_tesis_te" placeholder=" " 
                                                value="<?php echo $id_tesis_te;?>"/></td>
                                    ...
                                    <td colspan="3"><a href="agregar_3.php?ci_p=<?php echo $row['ci_p'];?>&id_tesis_te=<?php echo $id_tesis_te;?>&estatus_tutor_acad=<?php echo $estatus_tutor_acad;?>">Agregar</a></td>
                                </tr>
