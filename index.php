    ...
    <body>
        ...
        <center>
            <article ><br>
                    ...
                    <form  action="./usuarios/loginSession.php" method="POST">
                        <tr>
                            ...
                            <td><input type="text" name="usuario" autofocus required placeholder="Nombre de Usuario" 
                                    value="" minlength="3" maxlength="13" required pattern="[A-Za-z,0-9,-,_,""]+" autocomplete="off"
                                    title=" Tamaño mínimo: 3 Tamaño máximo: 13"/></td>
                        </tr>
                            <td><label>Clave</td>

                            <td><input type="password" name="clave" required placeholder="Incluye - ñ _ * /" 
                                    value="" minlength="3" maxlength="10" required pattern="[A-Za-z,0-9,-,ñ,*,/,_]+" autocomplete="off"
                ...
                <td><a href="./usuarios/recu_clave.php" >Recuperar Usuario ó Clave</a></td>
            </article>
        </center>
      
            <h2 class="sms"> Primera vez :<br>
                            USUARIO :admin<br>
                            CLAVE :admin</h2>
